  ...
  <div>
    ...
    <el-form :inline="true" :model="searchForm" class="demo-form-inline">
      ...
      <el-form-item label="时间范围" v-if="searchForm.dimension === 'month'">
        <el-date-picker v-model="searchForm.dateRange" type="monthrange" range-separator="至" start-placeholder="开始月份"
          end-placeholder="结束月份" value-format="YYYY-MM" @change="handleDateRangeChange" />
      </el-form-item>
